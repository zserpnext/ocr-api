 ...
 * @author :ljq
 * @date :2023/11/9
 * @description: ocr识别service实现-通过注解的方式实现熔断限流
 */
@Slf4j
//@Service
public class OcrServiceImpl2 implements OcrService {
    ...
    @Override
    @SentinelResource(value = "ocr-python-api", blockHandler = "ocrTextBlockHandler")
    ...
    @Override
    @SentinelResource(value = "ocr-python-api", blockHandler = "ocrTextAccuracyLocationBlockHandler")
    ...
    public List<String> ocrTextBlockHandler(String imgBase64, String imgType, BlockException ex) {
        log.error("ocr限流或降级 imageBase64:{} imgType:{}",imgBase64,imgType,ex);
        throw new ServiceException(PADDLE_OCR_TOO_FREQUENTLY);
    }

    public List<TextAccuracyLocationDto> ocrTextAccuracyLocationBlockHandler(String imgBase64, String imgType, BlockException ex) {
        log.error("ocr限流或降级 imageBase64:{} imgType:{}",imgBase64,imgType,ex);
        throw new ServiceException(PADDLE_OCR_TOO_FREQUENTLY);
    }
